...
class MymercatoModel extends AdminModel
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_mymercatos.mymercato', 'mymercato', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_mymercatos.edit.mymercato.data', array());
		...
		$this->preprocessData('com_mymercatos.mymercato', $data);
