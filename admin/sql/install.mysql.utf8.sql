...
CREATE TABLE IF NOT EXISTS `#__mymercatos` (
  ...
  `tuaemail` int(11) NOT NULL DEFAULT '0',
...
INSERT IGNORE INTO `#__mymercatos` (`id`, `title`, `description`, `costo`, `marca`, `tipo`, `tuaemail`, `nome`, `picture`, `width`, `height`, `alt`) VALUES
(1, 'City Centre', 'Highligts of Anycity', '5', 1, 1, 0, 0, NULL, NULL, NULL, ''),
(2, 'Woods', 'Woodland mercato on hard paths', '4', 0, 0, 1, 1, NULL, NULL, NULL, ''),
(3, 'Tuaemail', 'Hill mercato with good views on established path.', '6', 0, 0, 3, 2, NULL, NULL, NULL, ''),
(4, 'Lake Thingy', 'Mercato around the lake on an accessible path.', '2', 1, 1, 0, 0, NULL, NULL, NULL, ''),
(5, 'Castle Railway Track', 'Mercato along the line of the old railway track from start point car park to Thing castle', '2', 1, 1, 0, 0, NULL, NULL, NULL, '');
