...
namespace J4xdemos\Component\Mymercatos\Administrator\Service\HTML;
...
class AdministratorService
{
	...
	public function association($articleid)
	{
		...
		if ($associations = Associations::getAssociations('com_mymercatos', '#__mymercatos', 'com_mymercatos.item', $articleid))
		{
